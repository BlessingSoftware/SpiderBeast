...
namespace SpiderBeast.Base
{
    ...
    abstract class Filter
    {
        ...
        public virtual List<FilterResult> FiltAsRoot(HtmlAgilityPack.HtmlNodeNavigator htmlDOM) {
        ...
        /// <returns></returns>
        public virtual bool FiltAsNode(HtmlAgilityPack.HtmlNodeNavigator htmlDOM)
        {
